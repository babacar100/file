...
<body>
	...
	<div id = "content">
		<br /><br /><br />
		<div class="alert alert-info"><h3>Comptes / Patients</h3></div> 
		<button class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span> Ajouter Patient</button>
		<br /><br />
			...
			<div class="modal-content">
				<form method="POST" action="update_student.php">	
					<div class="modal-header">
						<h4 class="modal-title">Mis a Jour Patient</h4>
					</div>
	...
	<div class="modal fade" id="modal_confirm" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center><h4 class="text-danger">Tous Les Fichiers Patients vont etre supprimés Aussi.</h4></center>
					<center><h3 class="text-danger">Voulez vous supprimer ces données?</h3></center>
				</div>
				<div class="modal-footer">
