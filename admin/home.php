...
<html lang = "en">
	<head>
		<title> Systeme Imagerie Medical</title>
		<meta charset = "utf-8" />
...
<body>
	...
	<div id = "content">
		<br /><br /><br />
		<div class="alert alert-info"><h3>Tableau de Bord</h3></div> 
		<div>
        <div class="flex-container" style="width:50%;Text-align:center;float:left;">
			<div class="card" style="width: 28rem;">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Total Utilisateurs : <?php echo $users ?> </li>
					<li class="list-group-item"> <a href="user.php" class="btn btn-primary">Manager Utilisateurs</a> </li>
				</ul>
			</div>
		</div>
        <div class="flex-container" style="Text-align:center;Width:50%;float:right">
		  	<div class="card" style="width: 28rem;">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Total Patients :  <?php echo $students ?> </li>
					<li class="list-group-item"> <a href="student.php" class="btn btn-primary">Manager Patients</a> </li>
				</ul>
			</div>
		</div>
	</div>
